...
├── torus_200part_coarse_seeded_s61803399_lam11_adaptive.yaml  # N=200 λ=11 GOOD-seed (61803399) reseed of the above: same adaptive schedule/mesh, proven-clean seed — the fine-mesh deliverable run (avoids the seed-84172851 split, docs/reference/winner_take_all_partition_gap.md Manifestation C)
