...
`docs/reference/PHASE1_HIGHN_APPROACHES_ABCDE.md`. ⚠ **`results/` is untracked,
so each git worktree has its own** — the N=300 Phase 2 baselines live in
`/Users/teban/Development/projects/surface-partition-territory/results/`
(`run_20260806_123326` at V=47,488 → 323.3192; `run_20260808_191030` at
V=114,144 → 322.9622), *not* in this checkout. Enumerate **both** working
directories before claiming a run does not exist; the plan's v1 got this wrong.
