...
├── torus_200part_coarse_seeded_lam9_adaptive.yaml  # N=200 λ=9 bad-seed, adaptive coarse-only schedule (wta_schedule: adaptive), 5 levels (finest 348×328=114k) — the affordable fine-mesh deliverable run
